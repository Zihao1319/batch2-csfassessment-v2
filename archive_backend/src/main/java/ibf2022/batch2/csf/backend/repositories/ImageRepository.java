...
public class ImageRepository {
    ...
    public String upload(MultipartFile file) throws IOException {
        ...
        PutObjectRequest putReq = new PutObjectRequest(bucketName, "%s.%s".formatted(id, fileNameExt),
        ...
        String url = IMAGE_URL + "%s.%s".formatted(id, fileNameExt);

        return url;
    }

    // public String upload(ZipEntry file) throws IOException {
    ...
    //     metadata.setContentType(fileNameExt);
